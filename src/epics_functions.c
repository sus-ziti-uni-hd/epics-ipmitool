...
static const iocshArg* ipmiConnectArgs[ 6 ] = { &ipmiConnectArg0,
  &ipmiConnectArg1, &ipmiConnectArg2, &ipmiConnectArg3, &ipmiConnectArg4, &ipmiConnectArg5 };
static const iocshFuncDef ipmiConnectFuncDef = { "ipmiConnect",
    6 /* # arguments */, ipmiConnectArgs };
